...
func (utilRef *t{{.GoFriendlyName}}Utils) {{$functionName}}(r io.Reader, opt *CopyFromReaderOptions, columns ...string) (int, error) {
	...
	return currentDbHandle.CopyFrom(pgx.Identifier{"{{.DbName}}"},colDbNames, copySourceReader)	
}
`
