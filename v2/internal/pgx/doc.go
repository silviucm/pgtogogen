...
github.com/silviucm/pgtogogen/v2/internal/pgx/stdlib to use pgx as a database/sql compatible driver.
...
pgx uses the github.com/silviucm/pgtogogen/v2/internal/pgx/pgtype library to support more types. See
